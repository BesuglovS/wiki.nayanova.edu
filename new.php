...
<head>
    ...
    <!-- Main -->
    <script src="upload/_js/mainNew.js"></script>
    <link rel="stylesheet" type="text/css" href="upload/_css/mainNew.css">
    ...
    <header class="cf">
        ...
        <div id="vk">
            ...
            <script type="text/javascript">
                VK.Widgets.Group("vk_groups", {mode: 1, width: "300", height: "70", color1: 'FFFFFF', color2: '2B587A', color3: '5B7FA6'}, 2691142);
            </script>
        </div>
        <h1>Диспетчерская<br />учебного отдела<br />СГОАН</h1>
    </header>
