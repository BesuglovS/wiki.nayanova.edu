...
class ZachDates {
    public function GetNearestZach($dbPrefix, $studentId){
        ...
        list($result, $discList) = $this->GetZachDates($dbPrefix, $studentId, $database);

        return $this->GetZachHtmlFromData($result, $discList);
    }

    public function GetLLDates($dbPrefix, $studentId)
    {
        global $database;
     ...
     * @return string
     */
    public function GetZachHtmlFromData($result, $discList)
    {
     ...
     * @return array
     */
    public function GetZachDates($dbPrefix, $studentId, $database)
    {
