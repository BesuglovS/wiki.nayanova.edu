...
<section id="groupsSchedule">
    ...
    <table id="dateScheduleTable">
        <tbody>
        <tr>
            <td><button id="8Math">8 А</button></td>
            <td><button id="9Math">9 А</button></td>
			<td><button id="10Math">10 А</button></td>
            <td><button id="11Math">11 А</button></td>
        </tr>
        <tr>
...
<section id="vk">
	...
	<img src="upload/images/sep1.jpg" style="display:block; margin:auto; border-radius: 10px; " width="300px" >
    <div style="text-align: center">До дня знаний осталось:</div>
