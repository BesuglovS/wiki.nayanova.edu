...
var groupNames = [
    ...
    "1 Г", "2 Г", "3 Г", "4 Г", "5 Г", "6 Г", "7 Г",
           "2 Д", "3 Д",                      "7 Д",
    "2 Г1", "2 Г2", "2 Д1", "2 Д2",
    "3 В1", "3 В2", "3 Г1", "3 Г2", "3 Д1", "3 Д2",
    "4 В1", "4 В2", "4 Г1", "4 Г2",
    "5 В1", "5 В2", "5 Г1", "5 Г2",
    "6 Б1", "6 Б2", "6 В1", "6 В2", "6 Г1", "6 Г2",
    "7 Г1", "7 Г2",
    "8 А1", "8 А2", "8 В1", "8 А2",
    "10 А1", "10 А2"
];
var groupIds = [
    ...
    "95",  "99", "103", "107",
    "96", "100",        "108",
    "61",  "65",  "70",  "75", "80", "84", "88",
    "62",  "66",  "71",  "76", "81", "85", "89",
    "63",  "67",  "72",  "77", "82", "86", "90",
    "64",  "68",  "73",  "78", "83", "87", "91",
           "69",  "74",                    "92",
    "109", "110", "111", "112",
...
var buttonSelectors = [
    ...
    "#1G", "#2G", "#3G", "#4G", "#5G", "#6G", "#7G",
           "#2D", "#3D",                      "#7D",
    "#2G1", "#2G2", "#2D1", "#2D2",
    "#3V1", "#3V2", "#3G1", "#3G2", "#3D1", "#3D2",
    "#4V1", "#4V2", "#4G1", "#4G",
    "#5V1", "#5V2", "#5G1", "#5G2",
    "#6B1", "#6B2", "#6V1", "#6V2", "#6G1", "#6G2",
    "#7G1", "#7G2",
    "#8Math1", "#8Math2", "#8Eco1", "#8Eco2",
    "#10Math1", "#10Math2"
];
...
$(function() {
    ...
    $( "#scheduleDate" ).datepicker( "option", "minDate", new Date(2017, 9 - 1, 1));
    $( "#scheduleDate" ).datepicker( "option", "maxDate", new Date(2017, 12 - 1, 31));
...
$(function() {
    ...
    var summer = new Date(2017, 9 - 1, 1);
